...
pub mod intcode {
    ...
    pub struct Cpu {
        ...
        pub memory: Vec<i128>,
        pub camera: crate::color_robot::ColorRobotHandle,
        pub camera_write_state: CameraWriteState,
        pub camera_command: crate::color_robot::MoveCommand,
    }
    ...
    impl Cpu {
        pub fn new() -> Cpu {
            Cpu {
                ...
                memory: Vec::new(),
                camera: crate::color_robot::spawn_color_robot(),
                camera_write_state: CameraWriteState::Paint,
                camera_command: crate::color_robot::MoveCommand {
                    dir: crate::color_robot::Turn::Left,
                    color: crate::color_robot::Color::Black,
                },
            }
        }
        ...
        pub fn exec(&mut self) {
            ...
            match instruction.opcode {
                ...
                3 => match self.input_mode {
                    ...
                    IOMode::CAMERA => {
                        match crate::color_robot::robot_color(&self.camera) {
                            crate::color_robot::Color::Black => {
                                self.write_arg(self.memory[self.pc + 1], 0, instruction.mode_1);
                            }
                            crate::color_robot::Color::White => {
                                self.write_arg(self.memory[self.pc + 1], 1, instruction.mode_1);
                            }
                        }
                ...
                4 => {
                    match self.output_mode {
                        IOMode::CAMERA => {
                            let output_val =
                                self.get_arg(self.memory[self.pc + 1], instruction.mode_1);

                            match self.camera_write_state {
                                CameraWriteState::Paint => {
                                    if output_val == 0 {
                                        self.camera_command.color =
                                            crate::color_robot::Color::Black;
                                    } else {
                                        self.camera_command.color =
                                            crate::color_robot::Color::White;
                                    }
                                    self.camera_write_state = CameraWriteState::Move;
                                }
                                CameraWriteState::Move => {
                                    if output_val == 0 {
                                        self.camera_command.dir = crate::color_robot::Turn::Left;
                                    } else {
                                        self.camera_command.dir = crate::color_robot::Turn::Right;
                                    }
                                    crate::color_robot::command_robot(
                                        &self.camera,
                                        self.camera_command.clone(),
                                    );
                                    self.camera_write_state = CameraWriteState::Paint;
                                }
                            }
                        }
                        IOMode::TERMINAL => {
                ...
                5 => {
                    ...
                    if arg != 0 {
                        self.pc =
                            self.get_arg(self.memory[self.pc + 2], instruction.mode_2) as usize;
                    } else {
                        self.pc += 3;
                    }
                }
